...
public class Lua_Hugula_PLua : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int DestoryLua_s(IntPtr l) {
		try {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int MultipleRequires_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(argc==1){
				System.String[] a1;
				checkArray(l,1,out a1);
				var ret=Hugula.PLua.MultipleRequires(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				var ret=Hugula.PLua.MultipleRequires(a1,a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,DestoryLua_s);
		addMember(l,PreInitLua_s);
		addMember(l,MultipleRequires_s);
		addMember(l,Delay_s);
