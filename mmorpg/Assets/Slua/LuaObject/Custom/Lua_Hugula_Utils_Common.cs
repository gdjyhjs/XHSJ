...
public class Lua_Hugula_Utils_Common : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_LUA_BUNDLE_NAME_X86(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.Common.LUA_BUNDLE_NAME_X86);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_LUA_BUNDLE_NAME_X64(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.Common.LUA_BUNDLE_NAME_X64);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"LUA_BUNDLE_NAME_X86",get_LUA_BUNDLE_NAME_X86,null,false);
		addMember(l,"LUA_BUNDLE_NAME_X64",get_LUA_BUNDLE_NAME_X64,null,false);
