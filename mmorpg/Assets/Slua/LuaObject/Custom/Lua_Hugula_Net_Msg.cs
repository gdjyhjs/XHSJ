...
public class Lua_Hugula_Net_Msg : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int ToByteStr(IntPtr l) {
		try {
			Hugula.Net.Msg self=(Hugula.Net.Msg)checkSelf(l);
			var ret=self.ToByteStr();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int ReadBffer(IntPtr l) {
		try {
			Hugula.Net.Msg self=(Hugula.Net.Msg)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
			var ret=self.ReadBffer(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
