...
public class Lua_Hugula_Utils_CUtils : LuaObject {
	...
	static public int GetBaseName_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			var ret=Hugula.Utils.CUtils.GetBaseName(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int GetAndroidABLoadPath_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			var ret=Hugula.Utils.CUtils.GetAndroidABLoadPath(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int get_printLog(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.CUtils.printLog);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_bundleIdentifier(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.CUtils.bundleIdentifier);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_realPersistentDataPath(IntPtr l) {
		try {
			string v;
			checkType(l,2,out v);
			Hugula.Utils.CUtils.realPersistentDataPath=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public int set_realStreamingAssetsPath(IntPtr l) {
		try {
			string v;
			checkType(l,2,out v);
			Hugula.Utils.CUtils.realStreamingAssetsPath=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_uncompressStreamingAssetsPath(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.CUtils.uncompressStreamingAssetsPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_realUncompressStreamingAssetsPath(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,Hugula.Utils.CUtils.realUncompressStreamingAssetsPath);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"uncompressStreamingAssetsPath",get_uncompressStreamingAssetsPath,null,false);
		addMember(l,"realUncompressStreamingAssetsPath",get_realUncompressStreamingAssetsPath,null,false);
