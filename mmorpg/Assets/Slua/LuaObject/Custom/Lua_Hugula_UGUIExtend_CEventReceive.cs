...
public class Lua_Hugula_UGUIExtend_CEventReceive : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int OnInputFieldValueChangedEvent(IntPtr l) {
		try {
			Hugula.UGUIExtend.CEventReceive self=(Hugula.UGUIExtend.CEventReceive)checkSelf(l);
			UnityEngine.Object a1;
			checkType(l,2,out a1);
			self.OnInputFieldValueChangedEvent(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int OnInputFieldValueChangedEnd(IntPtr l) {
		try {
			Hugula.UGUIExtend.CEventReceive self=(Hugula.UGUIExtend.CEventReceive)checkSelf(l);
			UnityEngine.Object a1;
			checkType(l,2,out a1);
			self.OnInputFieldValueChangedEnd(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,OnInputFieldValueChangedEvent);
		addMember(l,OnInputFieldValueChangedEnd);
