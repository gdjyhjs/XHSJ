...
public class Lua_Hugula_UGUIExtend_ScrollRectTable : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int ItemsDispose(IntPtr l) {
		try {
			Hugula.UGUIExtend.ScrollRectTable self=(Hugula.UGUIExtend.ScrollRectTable)checkSelf(l);
			self.ItemsDispose();
			pushValue(l,true);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_onBottom(IntPtr l) {
		try {
			Hugula.UGUIExtend.ScrollRectTable self=(Hugula.UGUIExtend.ScrollRectTable)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.onBottom);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_onBottom(IntPtr l) {
		try {
			Hugula.UGUIExtend.ScrollRectTable self=(Hugula.UGUIExtend.ScrollRectTable)checkSelf(l);
			SLua.LuaFunction v;
			checkType(l,2,out v);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"onBottom",get_onBottom,set_onBottom,true);
