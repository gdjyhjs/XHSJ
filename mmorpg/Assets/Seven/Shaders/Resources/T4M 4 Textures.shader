Shader "T4MShaders/ShaderModel2/Diffuse/T4M 4 Textures(rgb and a)" {
Properties {
	...
	_ControlATex ("Control (Alpha)", 2D) = "white" {}
...
sampler2D _Control;
sampler2D _ControlATex;
sampler2D _Splat0,_Splat1,_Splat2,_Splat3;
 
void surf (Input IN, inout SurfaceOutput o) {
	fixed4 splat_control = tex2D (_Control, IN.uv_Control).rgba;
	fixed4 alpha = tex2D(_ControlATex, IN.uv_Control);
	splat_control.a = (alpha.r + alpha.g + alpha.b);
