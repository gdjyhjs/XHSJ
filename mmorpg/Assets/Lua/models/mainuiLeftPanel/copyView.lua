...
local CopyView=class(leftPanelBase,function(self,item_obj,...)
	print("wtf task copy")
    leftPanelBase._ctor(self, "mainui_tower.u3d", item_obj,...) -- 资源名字全部是小写
...
function CopyView:on_asset_load(key,asset)
	...
	self:update_view()
	CopyView._base.on_asset_load(self,key,asset)
end
