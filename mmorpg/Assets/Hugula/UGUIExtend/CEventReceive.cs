...
namespace Hugula.UGUIExtend
{
    ...
    public class CEventReceive : MonoBehaviour//, ISelectHandler//,IPointerClickHandler, IPointerDownHandler, IPointerUpHandler, IBeginDragHandler, IDragHandler, IDropHandler, ICancelHandler
    {
        ...
        public void OnPointerDown(BaseEventData eventData)
        {
			...
			UGUIEvent.onPointerDownHandle(g, eventData);
        }

        public void OnPointerUp(BaseEventData eventData)
        {
            var g = eventData.selectedObject;
			UGUIEvent.onPointerUpHandle(g, eventData);
        }
		...
		public void OnInputFieldValueChangedEvent(Object arg)
		{
			var g = EventSystem.current.currentSelectedGameObject;
			if(g==null&&arg!=null)
				g = arg as GameObject;
			UGUIEvent.onInputFieldValueChangedHandler(g, arg); //Debug.Log("you are click "+g);
		}

		public void OnInputFieldValueChangedEnd(Object arg)
		{
			var g = EventSystem.current.currentSelectedGameObject;
			UGUIEvent.onInputFieldValueEndHandler(g, arg);
		}
    }
}