     ...
     public const BuildTarget target = BuildTarget.StandaloneOSXIntel;
        ...
        public static void SetAssetBundleName(Object s, bool replace = false, bool variant = false, string variantName = null)
        {
            ...
            { //UnityEngine.SceneAsset
				...
				EditorApplication.SaveScene(AssetDatabase.GetAssetPath(s));
            }
...
//				if (aFiles.Length > 0) {
//					if (aFiles [0].Contains ("Scene/")) {
//						sceneList.Add (aFiles);
//						sceneNameList.Add (assetBundleName);
//					} else {
//						otherList.Add (aFiles);
//						otherNameList.Add (assetBundleName);
//					}
//				} else {
//					otherList.Add (aFiles);
//					otherNameList.Add (assetBundleName);
...
//			AssetBundleBuild[] buildSceneMap = new AssetBundleBuild[sceneList.Count];
//
//			int index = 0;
//			foreach (string[] files in sceneList) {
//				buildSceneMap [index].assetBundleName = sceneNameList [index];
//				buildSceneMap [index].assetNames = files;
//				index++;
//			}
//			
//			// Create the array of bundle build details.
//			AssetBundleBuild[] buildOtherMap = new AssetBundleBuild[otherList.Count];
//
//			index = 0;
//			foreach (string[] files in otherList) {
//				buildOtherMap [index].assetBundleName = otherNameList [index];
//				buildOtherMap [index].assetNames = files;
//				index++;
//			}
//			ab = BuildPipeline.BuildAssetBundles (EditorUtils.GetOutPutPath (), buildSceneMap, BuildAssetBundleOptions.DeterministicAssetBundle, target);
//			BuildPipeline.BuildAssetBundles (EditorUtils.GetOutPutPath (), buildOtherMap, BuildAssetBundleOptions.ChunkBasedCompression, target);
//
//			CUtils.DebugCastTime ("Time BuildPipeline.BuildAssetBundles End");
		}
