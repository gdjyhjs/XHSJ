...
version_html_path = cur_path + "/tools/autobuild/scripts/textureVer.html"
version_txt_path = cur_path + "/tools/autobuild/scripts/textureVer.txt"

username = "Seven"
password = "kinglong"
url  = u'https://192.168.0.254/svn/yckj/美术需求和出图/UI/UI输出/Texture/'
