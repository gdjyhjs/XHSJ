...
/// </summary>
[System.Serializable]
public class  StaticIDData<T> :  StaticData
{
    public T Id;
...
/// 静态数据表基类
/// </summary>
public class  StaticDataTableBase : MonoBehaviour
{
...
/// 静态数据表基类
/// </summary>
public class  StaticDataTable<T> :  StaticDataTableBase where T :  StaticData, new()
{
    //数据存放区，序列化时存储
...
public class  StaticIDDataTable<T, TK> :  StaticDataTable<T> where T :  StaticIDData<TK>, new()
{
...
[System.Serializable]
public class  LookupGroup<T, TK, TK2> where T:  StaticIDData<TK>, HasKey2<TK2>, new()
{
    public TK2 groupId;
    public List<T> groupedElements;
}

public class  AddtionalLookupGroup<T, TK, TK2>  where T :  StaticIDData<TK>, HasKey2<TK2>, new()    
{
    [SerializeField]
    public  LookupGroup<T, TK, TK2>[] groups;
    private Dictionary<TK2,  LookupGroup<T, TK, TK2>> lookupTable=null;
