Shader "Hidden/TerrainEngine/Splatmap/EasyTerrain_Standard_AddPass" 
{
    Properties 
    {
    ...
    SubShader 
    {
        ...
        CGPROGRAM
            #pragma surface surf Standard fullforwardshadows decal:add finalcolor:SplatmapFinalColor
            #pragma target 3.0
            ...
            #define _EASYTERRAIN_STANDARD_SPLAT_ADDPASS
