Shader "Hidden/TerrainEngine/Splatmap/EasyTerrain_Diffuse_AddPass" 
{
    Properties 
    {
    ...
    SubShader 
    {
        ...
        CGPROGRAM
            #pragma surface surf Lambert fullforwardshadows decal:add finalcolor:SplatmapFinalColor
            #pragma target 3.0
            ...
            #define _EASYTERRAIN_DIFFUSE_SPLAT_ADDPASS
