#ifndef EasyTerrain_Diffuse_Tools
#define EasyTerrain_Diffuse_Tools
    ...
    void SetWorldVariables(in Input IN, in SurfaceOutput o) 
    {
    ...
    void SplatmapFinalColor(Input IN, SurfaceOutput o, inout fixed4 color)
    {
        color *= o.Alpha;
