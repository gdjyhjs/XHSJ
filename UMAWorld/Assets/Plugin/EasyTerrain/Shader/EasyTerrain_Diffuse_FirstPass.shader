Shader "Nature/Terrain/EasyTerrain_Diffuse" 
{
    Properties 
    {
    ...
    SubShader 
    {
        ...
        CGPROGRAM
            #pragma surface surf Lambert fullforwardshadows finalcolor:SplatmapFinalColor
            #pragma target 3.0
            ...
            #include "EasyTerrain_Diffuse_Tools.cginc"
            ...
            void surf (Input IN, inout SurfaceOutput o) 
            {
                ...
                #if defined(_EASYTERRAIN_DIFFUSE_SPLAT_ADDPASS)
                    clip(weight == 0 ? -1 : 1);
                #endif
    ...
    Dependency "AddPassShader" = "Hidden/TerrainEngine/Splatmap/EasyTerrain_Diffuse_AddPass"    
    Dependency "BaseMapShader" = "Hidden/TerrainEngine/Splatmap/EasyTerrain_Diffuse_Base" 
