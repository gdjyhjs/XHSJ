...
public class ConfSchoolFloorBase : ConfBase
{
	...
	private void Init1()
	{
		...
		allConfBase.Add(new ConfSchoolFloorItem(27, 15f, 15f, 15f, "Prefab/Build/Tree/SchoolBambooA"));
		allConfBase.Add(new ConfSchoolFloorItem(28, 15f, 15f, 15f, "Prefab/Build/Tree/SchoolBambooB"));
		allConfBase.Add(new ConfSchoolFloorItem(29, 15f, 15f, 15f, "Prefab/Build/Tree/SchoolBambooC"));
