...
public class ConfSchoolFloorBase : ConfBase
{
	...
	private void Init1()
	{
		...
		allConfBase.Add(new ConfSchoolFloorItem(10, 12f, 8f, 16f, "Prefab/Build/House/SchoolOutHouse"));
		allConfBase.Add(new ConfSchoolFloorItem(11, 12f, 8f, 16f, "Prefab/Build/House/SchoolTransmit"));
		allConfBase.Add(new ConfSchoolFloorItem(12, 12f, 8f, 16f, "Prefab/Build/House/SchoolTaskBar"));
	}
