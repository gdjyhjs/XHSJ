...
public class ConfLanguageBase : ConfBase
{
	...
	private void Init1()
	{
		...
		allConfBase.Add(new ConfLanguageItem(146, "Pants 1", "低腰裤", "Pants 1"));
		allConfBase.Add(new ConfLanguageItem(147, "Pants 2", "花裤子", "Pants 2"));
		allConfBase.Add(new ConfLanguageItem(148, "FemaleLongHair", "中分", "Long Hair"));
		allConfBase.Add(new ConfLanguageItem(149, "FemalePonyTail", "马尾1", "Pony Tail"));
		allConfBase.Add(new ConfLanguageItem(150, "Hair 1", "双马尾", "Hair 1"));
		allConfBase.Add(new ConfLanguageItem(151, "Hair 2", "短发", "Hair 2"));
		allConfBase.Add(new ConfLanguageItem(152, "Hair 3", "梨花头", "Hair 3"));
		allConfBase.Add(new ConfLanguageItem(153, "BoneyTail", "马尾2", "Boney Tail"));
		allConfBase.Add(new ConfLanguageItem(154, "High Tops - Black", "黑色", "High Tops Black"));
		allConfBase.Add(new ConfLanguageItem(155, "High Tops - Turquoise", "松绿", "High Tops Turquoise"));
		allConfBase.Add(new ConfLanguageItem(156, "High Tops - White", "白色", "High Tops White"));
		allConfBase.Add(new ConfLanguageItem(157, "Color", "颜色", "Color"));
		allConfBase.Add(new ConfLanguageItem(158, "Lipstick", "口红", "Lipstick"));
		allConfBase.Add(new ConfLanguageItem(159, "Shirt", "衬衫", "Shirt"));
