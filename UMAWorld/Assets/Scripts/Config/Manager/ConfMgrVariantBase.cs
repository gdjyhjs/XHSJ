...
public class ConfMgrVariantBase
{
	...
	public ConfSchoolColor schoolColor { get { g.game.conf.schoolColor.onGetItemObjectHandler = GetItemObjectHandler(g.game.conf.schoolColor); return g.game.conf.data.schoolColor; } }		//建筑生成.xlsx
