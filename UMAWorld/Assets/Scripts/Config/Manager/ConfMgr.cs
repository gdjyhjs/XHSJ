...
public class ConfMgr
{
    public class Data
    {
		...
		public ConfSchoolColor schoolColor = new ConfSchoolColor();
	...
	public ConfSchoolColor schoolColor { get { data.schoolColor.onGetItemObjectHandler = null; return data.schoolColor; } }		//建筑生成.xlsx
